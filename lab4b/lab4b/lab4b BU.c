...
// Allow local testing when DUMMY flag passed in compilation
//#ifdef DUMMY
...
//}
//
//void  mraa_gpio_isr(mraa_gpio_context c, int b, void (*fp)(void), int* idk) {
//}
//#else
//#include <mraa.h>
//#endif
...
void handleInput(char *inputLine);
...
int main(int argc, char * argv[]) {
    ...
    while (1) {
        ...
        // Handle temperature reading & matches period
...
void handleTemperature() {
    // Get the current time & temperature
    struct timespec ts;
    struct tm * tm;
...
void handleInput(char *inputLine) {
    // C-Strings end in '\0' so need to add it to the end
